//previous file, added bedrock for y<3 (3 layers against leaking because of 1.18.1 height upgrades, server gets stalled when filling it up with water)
//changed one tunnel generator larger bottom/height and trim. (More tnt on top and floor).
