...
#fill ~ ~ ~-2 ~ ~ ~2 repeating_command_block 0 keep {Command:"/function exxabite:stripe_xz",auto:1b}
fill ~-2 ~ ~-2 ~2 ~ ~2 repeating_command_block 0 keep {Command:"/function exxabite:stripe_xz",auto:1b}
