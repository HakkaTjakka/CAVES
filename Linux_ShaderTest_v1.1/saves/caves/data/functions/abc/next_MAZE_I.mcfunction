setblock ~ ~ ~ air 0
fill ~ ~ ~ ~ ~ ~ command_block 0 keep {Command:"/function abc:current_MAZE_H"}
...
fill ~6 ~7 ~7 ~6 ~7 ~7 command_block 0 keep {Command:"function abc:MAZE_SOUTH_NEXT_I"}
...
fill ~-7 ~7 ~-8 ~-7 ~7 ~-8 command_block 0 keep {Command:"function abc:MAZE_NORTH_NEXT_I"}
...
setblock ~7 ~7 ~-7 air 0
fill ~7 ~7 ~-7 ~7 ~7 ~-7 command_block 0 keep {Command:"function abc:MAZE_WEST_NEXT_I"}
...
fill ~-8 ~7 ~6 ~-8 ~7 ~6 command_block 0 keep {Command:"function abc:MAZE_EAST_NEXT_I"}
...
fill ~0 ~-5 ~0 ~0 ~-5 ~0 command_block 0 keep {Command:"/function abc:letter_MAZE_I"}
