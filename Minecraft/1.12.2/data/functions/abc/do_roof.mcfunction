...
#fill ~-64 253 ~ ~-64 253 ~ repeating_command_block 0 keep {Command:"function abc:do_roof2 if @e[r=64]",auto:1b}
#fill ~64 253 ~ ~64 253 ~ repeating_command_block 0 keep {Command:"function abc:do_roof2 if @e[r=64]",auto:1b}
#fill ~ 253 ~-64 ~ 253 ~-64 repeating_command_block 0 keep {Command:"function abc:do_roof2 if @e[r=64]",auto:1b}
#fill ~ 253 ~64 ~ 253 ~64 repeating_command_block 0 keep {Command:"function abc:do_roof2 if @e[r=64]",auto:1b}

fill ~-64 ~-20 ~ ~-64 ~-20 ~ repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=64]",auto:1b}
fill ~64 ~-20 ~ ~64 ~-20 ~ repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=64]",auto:1b}
fill ~ ~-20 ~-64 ~ ~-20 ~-64 repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=64]",auto:1b}
fill ~ ~-20 ~64 ~ ~-20 ~64 repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=64]",auto:1b}
