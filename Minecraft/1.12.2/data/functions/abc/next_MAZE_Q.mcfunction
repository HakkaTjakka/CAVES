setblock ~ ~ ~ air 0
fill ~ ~ ~ ~ ~ ~ command_block 0 keep {Command:"/function abc:current_MAZE_P"}
...
fill ~6 ~7 ~7 ~6 ~7 ~7 command_block 0 keep {Command:"function abc:MAZE_SOUTH_NEXT_Q"}
...
fill ~-7 ~7 ~-8 ~-7 ~7 ~-8 command_block 0 keep {Command:"function abc:MAZE_NORTH_NEXT_Q"}
...
setblock ~7 ~7 ~-7 air 0
fill ~7 ~7 ~-7 ~7 ~7 ~-7 command_block 0 keep {Command:"function abc:MAZE_WEST_NEXT_Q"}
...
fill ~-8 ~7 ~6 ~-8 ~7 ~6 command_block 0 keep {Command:"function abc:MAZE_EAST_NEXT_Q"}
...
fill ~0 ~-5 ~0 ~0 ~-5 ~0 command_block 0 keep {Command:"/function abc:letter_MAZE_Q"}
